...
"Output: JSON text only, in the format: {\"issues\": [<issue_explanation (e.g. Social Security Number fields don't match)>], \"accuracy\": 97%} with no explanations, no code blocks or triple quotes, no extra text."
)
